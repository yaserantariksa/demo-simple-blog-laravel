    ...
    <script>
        ...
        document.addEventListener('DOMContentLoaded', () => {
            ...
            const qlEditorObserver = new MutationObserver(() => {
                inputField.value = qlEditor.innerHTML;
            });
            ...
            if (inputField.value != null) {
                qlEditor.innerHTML = inputField.value;
            }
        });

        // text button save or published
        const draftCheckbox = document.getElementById('is_draft')
        const publishButton = document.getElementById('save_button')
